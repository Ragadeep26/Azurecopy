...
from src.main_piles_in_tension_offshore import piles_under_tension
from src.Introduction import introduction_page
from src.main_energy_calculator import main_energy_calculator
...
if __name__ == '__main__':
    ...
    elif select_event == 'Homepage':
        introduction_page(st)
    ...
    elif select_event == 'Piles In Tension for offshore':
        piles_under_tension(st)
    ...
    elif select_event == 'Energy Calculator':
        main_energy_calculator(st)
    ...
    st.sidebar.write('piles&panels=nya.11.2022, bjg.06.2023')
