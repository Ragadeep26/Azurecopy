...
def continue_program(st, parameters):
    ...
    pdf1_hyperlink_sharepoint = 'https://bauergroup-my.sharepoint.com/:b:/r/personal/ragadeep_bojja_bauer_de/Documents/CO2_Calculator_EPD_Files/Mixed-in-Place%20(MIP)%20Baustoff%20der%20Klasse%2060-100.pdf?csf=1&web=1&e=06m4Ud'
    pdf2_hyperlink_sharepoint = 'https://bauergroup-my.sharepoint.com/:b:/r/personal/ragadeep_bojja_bauer_de/Documents/CO2_Calculator_EPD_Files/Mixed-in-Place%20(MIP)%20Baustoff%20der%20Klasse%20100-150.pdf?csf=1&web=1&e=nTZnb0'
    pdf3_hyperlink_sharepoint = 'https://bauergroup-my.sharepoint.com/:b:/r/personal/ragadeep_bojja_bauer_de/Documents/CO2_Calculator_EPD_Files/Mixed-in-Place%20(MIP)%20Baustoff%20der%20Klasse%20150-230.pdf?csf=1&web=1&e=635tKe'
    pdf4_hyperlink_sharepoint = 'https://bauergroup-my.sharepoint.com/:b:/r/personal/ragadeep_bojja_bauer_de/Documents/CO2_Calculator_EPD_Files/Mixed-in-Place%20(MIP)%20Baustoff%20der%20Klasse%20230-360.pdf?csf=1&web=1&e=HW46Mf'
    pdf5_hyperlink_sharepoint = 'https://bauergroup-my.sharepoint.com/:b:/r/personal/ragadeep_bojja_bauer_de/Documents/CO2_Calculator_EPD_Files/Mixed-in-Place%20(MIP)%20Baustoff%20der%20Klasse%20360-520.pdf?csf=1&web=1&e=yqj092'
    pdf6_hyperlink_sharepoint = 'https://bauergroup-my.sharepoint.com/:b:/r/personal/ragadeep_bojja_bauer_de/Documents/CO2_Calculator_EPD_Files/Mixed-in-Place%20(MIP)%20Baustoff%20der%20Klasse%20520-600.pdf?csf=1&web=1&e=gcE8qo'
    st.write("BAUER MIP Class I. [Open document]({})".format(pdf1_hyperlink_sharepoint))
    st.write("BAUER MIP Class II. [Open document]({})".format(pdf2_hyperlink_sharepoint))
    st.write("BAUER MIP Class III. [Open document]({})".format(pdf3_hyperlink_sharepoint))
    st.write("BAUER MIP Class IV. [Open document]({})".format(pdf4_hyperlink_sharepoint))
    st.write("BAUER MIP Class V. [Open document]({})".format(pdf5_hyperlink_sharepoint))
    st.write("BAUER MIP Class VI. [Open document]({})".format(pdf6_hyperlink_sharepoint))
